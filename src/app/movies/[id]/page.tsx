...
export async function generateMetadata({ params }: MovieDetailsPageProps) {
  ...
  try {
    ...
    return { title: `${movie.title} | Movflex` };
  } catch {
    return { title: 'Movie | Movflex' };
  }
}
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12">
          ...
          <div className="flex-1 min-w-0 flex flex-col">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-5">
              ...
              <span
                className={`inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-bold shadow-lg ${getRatingColor(movie.vote_average)}`}
              >
                {rating}
              </span>
            </div>
